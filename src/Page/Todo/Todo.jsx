...
function Todo() {
  ...
  function waitingClick(id) {
    ...
    setTodosRaw([...todosRaw])//great state now change
  }
  ...
  function addClick(id, title) {
    ...
    // todosRaw.push(newTodo)//ok but state not change 
    setTodosRaw([...todosRaw, newTodo])//great state now change
    ...
    <div className='todo-container'>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title><span className='bi bi-plus-lg'></span>
            &nbsp;Add Todo
          </Modal.Title>
        </Modal.Header>
      ...
      <div className='todo-filters-container'>
        <div className='form-check form-switch'>
          ...
          <div>
            <label className='form-check-label' htmlFor='flexSwitchCheckChecked' valign>
              Show only&nbsp;<button className='btn btn-warning'>waiting&nbsp;<span className='bi bi-clock'></span></button>
            </label>
          </div>
        </div>
        <select
      ...
      <table className='table table-striped todo-table'>
        <thead className='table-dark'>
          <tr>
            ...
            <th style={{ textAlign: 'right', width: '18%' }} valign='middle'>
              Completed&nbsp;
              <button className='btn btn-primary' onClick={handleShow}><span className="bi bi-plus-lg"></span></button>
            </th>
          </tr>
        </thead>
        <tbody>
